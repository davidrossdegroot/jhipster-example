...
import com.davidrossdegroot.config.oauth2.OAuth2AuthenticationReadConverter;
import com.davidrossdegroot.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("com.davidrossdegroot.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.davidrossdegroot.config.dbmigrations");
